...
@Component({
    ...
    styleUrls: [ 'ipt-recipe-review-details.component.css', '../common/reset.css' ],
...
export class IptRecipeReviewDetailsComponent implements OnInit {
    ...
    //返回列表页
    backToList(): void {
        // this.router.navigate(['/page/ipt-recipe-review']);
        let session = sessionStorage.getItem('iptRecipeReviewDetails');
        if(session){
            ...
            sessionStorage.removeItem('iptRecipeReviewDetails');
        }else{
            history.back();
        }
    }
